    ...
    <div >
        ...
        <?php else: ?>
            <section class="col col-lg-7">
                ...
                <table class="table table-bordered table-condensed">
                    <tr><th style="width: 20%;">Tuote:</th><td><?php if(isset($produtname)) echo $productname; ?></td></tr>
                    <tr><th>Kappaleita:</th><td><?php if(isset($productdate)) echo $productdate; ?></td></tr>
                    <tr><th>Yhteishinta:</th><td><?php if(isset($productprice)) echo $productprice; ?></td></tr>
                </table>
            </section>
        <?php endif ?>
    </div>
